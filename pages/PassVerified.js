...
//nothing else needs to be done just fix css and make better if have time
//check if Back to login button is good

export default function PassVerified({navigation}) {
  return (
